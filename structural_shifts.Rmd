...
ggplot(data=dRSA[rep==1 & site %in% seq(334,515),], aes(x=site, y=value, color=variable))+
  ...
  scale_x_continuous(expand=c(0.01,0.01),breaks=c(331,seq(335,530,by=5)))+
  theme(axis.text.x=element_text(angle=90,hjust=1,vjust=0.6,face="bold",size=10))+
  ylab("Change in relative solvent accessibility versus Wuhan-Hu-1 [6m0j]")+
...
ggplot(data=calpha[rep==1,],aes(x=abs(value),y=JSD_bind,color=variable))+
  geom_point(pch=19)+
  scale_color_manual(values=group.colors)+
  theme_classic()+
...
ggplot(data=cbeta[rep==1,],aes(x=abs(value),y=JSD_bind,color=variable))+
  geom_point(pch=19)+
  scale_color_manual(values=group.colors)+
  theme_classic()+
...
ggplot(data=dRSA[rep==1,],aes(x=abs(value),y=JSD_bind,color=variable))+
  geom_point(pch=19)+
  scale_color_manual(values=group.colors)+
  theme_classic()+
