...
diffs_bind$JSD_cens <- as.numeric(NA) #jensen-shannon distance, from bind_cens values (lower limit 6)
...
plot_scatter <- function(site, bg1, bg2, JSD=T, JSD_min3bc=F, JSD_min5bc=F,cutoff=5,phenotype="bind"){
