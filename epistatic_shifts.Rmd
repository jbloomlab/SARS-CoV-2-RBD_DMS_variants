...
```{r scatters_Beta_muts, echo=T, fig.width=9, fig.height=3, fig.align="center", dpi=300,dev="png"}
par(mfrow=c(1,3))
...
```
```{r corrs_Beta_WH1_446-loop, echo=T, fig.width=9, fig.height=3, fig.align="center", dpi=300,dev="png"}
par(mfrow=c(1,3))
...
```{r corrs_403-406-505-506, echo=T, fig.width=12, fig.height=3, fig.align="center", dpi=300,dev="png"}
par(mfrow=c(1,4))
...
```{r corrs_RBM-perturbations, echo=T, fig.width=21, fig.height=3, fig.align="center", dpi=300,dev="png"}
par(mfrow=c(1,7))
...
```{r corrs_419, echo=T, fig.width=9, fig.height=3, fig.align="center", dpi=300,dev="png"}
par(mfrow=c(1,3))
...
```{r corrs_expression-sites, echo=T, fig.width=9, fig.height=6, fig.align="center", dpi=300,dev="png"}
par(mfrow=c(2,3))
...
Plot mAb escape versus average DMS effect (in WH1 background?)
...
for(i in 1:nrow(site_escape)){
  site_escape$site_average_ACE2[i] <- median(dt[target=="Wuhan-Hu-1" & position==site_escape[i,site] & wildtype!=mutant,delta_bind],na.rm=T)
...
```{r epistatic_double_mut_cycle_bind_N501Y_G446V, echo=T, fig.width=3.5, fig.height=4, fig.align="center", dpi=300,dev="png"}
cycle_bind <- data.table()
...
```{r epistatic_double_mut_cycle_bind_N501Y_G446S, echo=T, fig.width=3.5, fig.height=4, fig.align="center", dpi=300,dev="png"}
cycle_bind <- data.table()
...
Look at specific mutation occurrences on each background. Want to know whether sites with strong differences in mutation effect profiles also differ in rates of substitution occurrence. Doing for N501 versus Y501, DMS and sub accrual.

First, showing counts of sub accrual on each background, colored by d-d-log10Ka
...
Alternative, try plotting d-d-bind as the y-axis, and x-axis as the ratio of counts on each background? Make Y501 the upper-right quadrant

```{r ddbind_v_count-ratio_color-by-ddlog10Kd, echo=T, fig.width=5, fig.height=3.5, fig.align="center", dpi=300,dev="png"}
...
Want a figure to illustrate concept of non-specific buffering of mutations in Omicron. Make a table and diagram illustrating the DMS effect of each of the 15 BA.1 RBD mutations as measured in the WH1 versus N501Y DMS datasets. Mutations in BA.1 RBD: G339D, S371L, S373P, S375P, K417N, N440K, G446S, S477N, T478K, E484A, Q493R, G496S, Q498R, N501Y, Y505H

```{r omicron_sub_compensation_WH1, echo=T, fig.width=3, fig.height=3.25, fig.align="center", dpi=300,dev="png"}
...
```
```{r omicron_sub_compensation_N501Y, echo=T, fig.width=3, fig.height=3.25, fig.align="center", dpi=300,dev="png"}
...
```
```{r omicron_sub_compensation_Beta, echo=T, fig.width=3, fig.height=3.25, fig.align="center", dpi=300,dev="png"}
...
Why difference in Beta and Alpha plots? Likely what we've seen in other contexts, some global effect in N501Y likely due to it having significantly higher base affinity than the other wildtype backgrounds? Can see this in the plot below, where mutations are biased to being slightly to the left of the 1:1 line.


```{r omicron_sub_compensation_alpha-v-beta, echo=T, fig.width=4, fig.height=3, fig.align="center", dpi=300,dev="png"}
...
```{r omicron_sub_compensation_beta-v-WH1, echo=T, fig.width=4, fig.height=4, fig.align="center", dpi=300,dev="png"}
...
```{r omicron_sub_affinity-v-escape, echo=T, fig.width=4, fig.height=4, fig.align="center", dpi=300,dev="png"}
...
```{r omicron_sub_delta-affinity-v-delta-escape, echo=T, fig.width=4, fig.height=4, fig.align="center", dpi=300,dev="png"}
#used escape calculator to look at cumulative fraction of antibody binding retained as we follow the order of the mutations in the affinity arc
...
How valid is our assumption that mutations should combine addivitely in our DMS measurements?

We have access to some sporadic double (and higher order) mutants that were present in our libraries. Let's compare their measured versus actual affinity at a global level.

```{r additive_assumption, echo=T, fig.width=4, fig.height=4, fig.align="center", dpi=300,dev="png"}
