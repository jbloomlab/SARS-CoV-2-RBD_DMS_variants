...
```{r 2_missing_points_Kd, fig.width=8, fig.height=8, fig.align="center",dpi=300, warning=FALSE, results=FALSE,dev="png"}
par(mfrow=c(2,2))
...
And curves with avgcount < 3 (~600 accepted fits in this regime). These don't look too bad.

```{r 3_avgcount, fig.width=8, fig.height=8, fig.align="center",dpi=300, warning=FALSE, results=FALSE,dev="png"}
par(mfrow=c(2,2))
