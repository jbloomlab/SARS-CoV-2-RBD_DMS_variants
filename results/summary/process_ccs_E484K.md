...
```
    ...
    Saving plot to results/process_ccs/amplicons_E484K.pdf



    
![png](process_ccs_E484K_files/process_ccs_E484K_22_1.png)
...
![png](process_ccs_E484K_files/process_ccs_E484K_32_0.png)
...
![png](process_ccs_E484K_files/process_ccs_E484K_34_0.png)
...
![png](process_ccs_E484K_files/process_ccs_E484K_36_0.png)
...
![png](process_ccs_E484K_files/process_ccs_E484K_38_0.png)
...
![png](process_ccs_E484K_files/process_ccs_E484K_42_0.png)
...
```
    ...
    Read 386465 CCSs from 2 libraries and 1 targets.
...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      <th rowspan="2" valign="top">E484K</th>
      <th>pool1</th>
      <td>189314</td>
      <td>49540</td>
      <td>3.82</td>
...
![png](process_ccs_E484K_files/process_ccs_E484K_59_0.png)
...
![png](process_ccs_E484K_files/process_ccs_E484K_63_0.png)
...
![png](process_ccs_E484K_files/process_ccs_E484K_65_0.png)
...
![png](process_ccs_E484K_files/process_ccs_E484K_69_0.png)
...
![png](process_ccs_E484K_files/process_ccs_E484K_75_1.png)
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      <td>pool1</td>
      <td>AAAAAAAAACCAGAGG</td>
      <td>E484K</td>
      <td>T103G A104C C105T</td>
      <td>14</td>
    </tr>
    <tr>
      <td>pool1</td>
      <td>AAAAAAAACAGTAGCT</td>
      <td>E484K</td>
      <td>G109A T110A A111T T332A A333T</td>
      <td>1</td>
    </tr>
    <tr>
      <td>pool1</td>
      <td>AAAAAAAACCCTCTAA</td>
      <td>E484K</td>
      <td></td>
      <td>4</td>
    </tr>
    <tr>
      <td>pool1</td>
      <td>AAAAAAAAGAGTTCCG</td>
      <td>E484K</td>
      <td>T439G C440T C441T</td>
      <td>6</td>
    </tr>
  </tbody>
</table>
...
![png](process_ccs_E484K_files/process_ccs_E484K_84_0.png)
...
![png](process_ccs_E484K_files/process_ccs_E484K_86_1.png)
...
```
    ...
    Writing nucleotide variants to results/variants/nucleotide_variant_table_E484K.csv
...
![png](process_ccs_E484K_files/process_ccs_E484K_92_0.png)
...
```
    ...
    Read gene of 603 nts for E484K from data/PacBio_amplicon_E484K.gb
...
![png](process_ccs_E484K_files/process_ccs_E484K_100_0.png)
...
```
    ...
    Saving plot to results/figures/n_aa_muts_per_variant_E484K.pdf
    Saving plot to results/figures/n_codon_muts_per_variant_E484K.pdf



    
![png](process_ccs_E484K_files/process_ccs_E484K_102_1.png)
    



    
![png](process_ccs_E484K_files/process_ccs_E484K_102_2.png)
...
```
    ...
    Saving plot to results/figures/avg_muts_per_variant_E484K.pdf



    
![png](process_ccs_E484K_files/process_ccs_E484K_104_1.png)
...
![png](process_ccs_E484K_files/process_ccs_E484K_106_0.png)
...
```
    ...
    Saving plot to results/figures/variant_cumul_all_mut_coverage_E484K.pdf
    Saving plot to results/figures/variant_cumul_single_mut_coverage_E484K.pdf



    
![png](process_ccs_E484K_files/process_ccs_E484K_108_1.png)
    



    
![png](process_ccs_E484K_files/process_ccs_E484K_108_2.png)
...
![png](process_ccs_E484K_files/process_ccs_E484K_112_0.png)
    



    
![png](process_ccs_E484K_files/process_ccs_E484K_112_1.png)
...
![png](process_ccs_E484K_files/process_ccs_E484K_114_0.png)
    



    
![png](process_ccs_E484K_files/process_ccs_E484K_114_1.png)
...
```
    ...
    Writing codon-variant table to results/variants/codon_variant_table_E484K.csv
