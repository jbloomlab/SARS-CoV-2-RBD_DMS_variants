...
```
    ...
    Saving plot to results/process_ccs/amplicons_Wuhan_Hu_1.pdf
...
![png](process_ccs_Wuhan_Hu_1_files/process_ccs_Wuhan_Hu_1_63_0.png)
...
```
    ...
    Saving plot to results/figures/variant_cumul_all_mut_coverage_Wuhan_Hu_1.pdf
